...
if(($this->woocommerce_order_status === "checkout-draft")|| ($this->woocommerce_order_status === "wc-checkout-draft") || ($this->woocommerce_order_status === "draft")){
    ...
    public static function get_order_lines($wc_order,$action)
    {
        ...
        foreach ($wc_order->get_items() as $item) {
            ...
            if ($variation_id) {
                ...
                {
                    $original_price=$item->get_total(); // Price per single item
                }
